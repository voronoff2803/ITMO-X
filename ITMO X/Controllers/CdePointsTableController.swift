//
//  CdePointsTableController.swift
//  ITMO X
//
...
class CdePointsTableController: UITableViewController {
    let points: [CdeMark]

    init(points: [CdeMark], title: String) {
        self.points = points
    ...
    func decorate() {
        tableView.register(CdeSubjectCell.self, forCellReuseIdentifier: "CdeSubjectCell")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.setup(mark: points[indexPath.row])
